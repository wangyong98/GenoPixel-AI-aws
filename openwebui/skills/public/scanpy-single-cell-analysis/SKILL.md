...
description: Optional secondary skill for GenoPixels that adds general Scanpy single-cell analysis language and interpretation hints. It must not override GenoPixel tool availability rules or exact-copy plot formatting rules.
---
...
- Add concise Scanpy-oriented interpretation hints when they help the user understand a generated plot.
- Do not override GenoPixel tool-selection rules.
- Do not override exact-copy formatting for `canonical_response_markdown`.
- Do not imply access to tools or analysis steps that are not exposed by the current GenoPixel tool manifest.
